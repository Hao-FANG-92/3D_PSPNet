...
parser.add_argument('--learning_rate', type=float, default=0.0004, help='Initial learning rate [default: 0.001]')
...
os.system('cp train_pyramid_cuda.py %s' % (LOG_DIR)) # bkp of train procedure
...
def train_fine_tuning():
    ...
    with tf.device('/gpu:'+str(GPU_INDEX)):
        ...
        pred, end_points = fine_tuning_with_pyramid_cuda(pointnet_graph, pointclouds_pl, point_coords_in_voxels, num_scale, is_training_pl, bn_decay=bn_decay)
