...
def evaluate():
    ...
    with tf.device('/gpu:'+str(GPU_INDEX)):
        ...
        pred, end_points = fine_tuning_with_pyramid_cuda_test(pointclouds_pl, point_coords_in_voxels, num_scale, is_training_pl)
