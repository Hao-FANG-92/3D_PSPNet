...
pred_data_label_filenames = [line.rstrip() for line in open('log5_4_256_modified_dense_bn_relu_cuda_fine_tuning//output_filelist.txt')]
...
print("mIOU" + str(sum(iou_list)/13.0))
...
print("mAcc" + str(sum(accuracy_list)/13.0))